          ...
          <AnimatePresence mode="wait">
            {activeIndex === null ? (
              ...
              >
                {currentSkill.map(({ title, logo }, i) => (
                  <motion.button
                    ...
                    className="bg-light text-dark rounded-lg p-4 shadow-lg flex flex-col items-center cursor-pointer focus:outline-none focus:ring"
                  >
                    <img src={logo} alt={`${title} logo`} className="w-16 h-16 mb-4 rounded-[10px]" />
              ...
              <motion.div
                ...
                className="absolute inset-0 w-full h-fit bg-light text-dark rounded-[10px] p-10 z-10 flex flex-col items-start"
              >
                <img src={expandedSkill.logo} alt={expandedSkill.title} className="w-16 h-16 mb-6 rounded-[10px]" />
                <h3 className="text-3xl font-bold mb-6">{expandedSkill.title}</h3>
                <p className="text-base leading-relaxed max-w-2xl mb-4">{expandedSkill.desc}</p>
                ...
                <button
                  ...
                  className="absolute top-4 right-4 bg-dark text-light px-4 py-2 rounded-md text-sm hover:bg-[#333] focus:outline-none focus:ring transition"
