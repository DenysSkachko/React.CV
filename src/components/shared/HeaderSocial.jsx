...
const socials = [
  ...
  { Icon: FaTelegramPlane, top: '-top-2', left: 'left-20', color: '#26A5E4', url: 'https://t.me/stormstyle' },
  { Icon: FaYoutube, top: 'top-6', left: 'left-20', color: '#FF0000', url: 'https://www.youtube.com/@DenysSkachko' },
    ...
    <div className="absolute top-2 right-2 w-[250px] h-[80px]">
      ...
      {socials.map(({ Icon, top, left, color, url }, i) => (
        <a
          ...
          className={`absolute ${top} ${left} text-4xl transition-transform duration-300 hover:scale-110 z-10`}
          style={{ color }}
        >
          <Icon />
        </a>
