...
const socials = [
  ...
  },
  {
    ...
    left: 'left-40',
    color: '#EA4335',
    url: 'https://mail.google.com/mail/?view=cm&to=denya.skachko@gmail.com',
  },
    ...
    <div className="absolute top-2 right-2 w-[250px] h-[80px]">
      {socials.map(({ Icon, top, left, color, url }, i) => (
        <a
          ...
          className={`absolute ${top} ${left} text-4xl transition-transform duration-300 hover:scale-125 z-10 shadow-2xl`}
          style={{ color }}
        >
          <Icon />
        </a>
