    ...
    skills: [
      {
        ...
        description:
          'Structured thinking under chaos',
      },
      {
        name: 'Seamless Switching',
        description: 'Fast context switcher',
      },
      {
      ...
      },
      {
        name: 'Keep Calm',
        description:
          'Calm under irrational pressure',
      },

      {
        name: 'Learn Daily',
        description:
          'Every day I learn something new to upgrade my thinking, tools, or workflow',
      },
    ],
  },
]
